...
- (void)prepare
{
    ...
    self.stateLabel.font = [UIFont systemFontOfSize:10.f];
    ...
    UIImageView *logo = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"icon_nill"]];
...
- (void)placeSubviews
{
    ...
    self.logo.mj_size = CGSizeMake(self.mj_w, 667.f);
...
//        self.gifView.mj_w = self.mj_w * 0.5 - textWidth * 0.5 - self.labelLeftInset;
        ...
        self.gifView.mj_size = CGSizeMake(30, 30);
        self.gifView.mj_y = 10;
        self.gifView.mj_x = (self.mj_w - 30) * 0.5;

        self.stateLabel.mj_y = CGRectGetMaxY(self.gifView.frame);
        self.stateLabel.mj_size = CGSizeMake(200, 20);
        self.stateLabel.mj_x = (self.mj_w - 200) * 0.5;
