...
#import "KJWebNavView.h"

@interface KJWebNavView ()
...
- (void)initView {
    ...
    [leftBtn setTitleColor:Color(0x33, 0x33, 0x3) forState:UIControlStateNormal];
    ...
    [closeBtn setTitleColor:Color(0x33, 0x33, 0x33) forState:UIControlStateNormal];
...
- (void)setCloseHidden:(BOOL)closeHidden {
    _closeHidden = closeHidden;
...
- (void)layoutSubviews {
    ...
    self.closeBtn.size = CGSizeMake(40, 30);
    self.closeBtn.centerY = self.titleLabel.centerY;
    self.closeBtn.x = self.leftBtn.right;
